...
type TuplePrefix<T extends IterableContainer> = [
    ...TupleParts<T>["required"],
    ...(Partial<TupleParts<T>["optional"]> extends ReadonlyArray<unknown> ? Partial<TupleParts<T>["optional"]> : RemedaTypeError<"TupleParts", "Partial on arrays should always result in an array", {
        type: never;
        metadata: [Partial<TupleParts<T>["optional"]>, T];
    }>)
];

export type { TuplePrefix as T, TupleParts as a };
