...
import { N as NTuple } from './NTuple-BgsZT9dJ.cjs';
import { T as TuplePrefix, a as TupleParts } from './TupleParts-BpqnmZOj.cjs';
import './RemedaTypeError-BIoNlKC-.cjs';

type Drop<T extends IterableContainer, N extends number> = IsNegative<N> extends true ? T : IsInteger<N> extends false ? Array<T[number]> : TuplePrefix<T> extends [...NTuple<unknown, N>, ...infer Remaining] ? [
    ...Remaining,
    ...CoercedArray<TupleParts<T>["item"]>,
    ...TupleParts<T>["suffix"]
] : 0 extends TupleParts<T>["suffix"]["length"] ? CoercedArray<TupleParts<T>["item"]> : DropUpTo<TupleParts<T>["suffix"], Subtract<Subtract<N, TupleParts<T>["required"]["length"]>, TupleParts<T>["optional"]["length"]>> | [...Array<TupleParts<T>["item"]>, ...TupleParts<T>["suffix"]];
/**
