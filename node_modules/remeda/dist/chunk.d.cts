...
import { I as IntRangeInclusive } from './IntRangeInclusive-Cn-qsrAN.cjs';
...
type LiteralChunk<T extends IterableContainer, N extends number> = ChunkInfinite<ChunkFinite<TuplePrefix<T>, N>, TupleParts<T>["item"], TupleParts<T>["suffix"], N> | ([
    ...TuplePrefix<T>,
    ...TupleParts<T>["suffix"]
]["length"] extends 0 ? [] : never);
/**
